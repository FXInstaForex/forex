...
import java.util.List;
    @InitiatedBy(QueryFlowB.class)
    public class QueryResponderFlowB extends FlowLogic<List<StateAndRef<PartyBalanceStateB>>> {


        private final FlowSession otherPartySession;

        public QueryResponderFlowB(FlowSession otherPartySession) {
