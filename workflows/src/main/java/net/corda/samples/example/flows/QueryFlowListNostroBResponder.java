...
@InitiatedBy(QueryFlowListNostroB.class)
public class QueryFlowListNostroBResponder extends FlowLogic<List<StateAndRef<PartyBNostroState>>> {


    private final FlowSession otherPartySession;

    public QueryFlowListNostroBResponder(FlowSession otherPartySession) {
    ...
    public List<StateAndRef<PartyBNostroState>> call() throws FlowException {
        ...
        System.out.println("QI am inside PartyBNostroState responder function ----------");
