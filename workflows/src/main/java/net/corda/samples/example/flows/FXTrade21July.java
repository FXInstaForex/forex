...
@InitiatingFlow
@StartableByRPC
public class FXTrade21July extends FlowLogic<Void> {

    private final SignedTransaction signedTransaction;
    private static final ProgressTracker.Step GENERATING_TRANSACTION = new ProgressTracker.Step("1Generating transaction");
    private static final ProgressTracker.Step VERIFYING_TRANSACTION = new ProgressTracker.Step("1Verifying transaction");
    private static final ProgressTracker.Step SIGNING_TRANSACTION = new ProgressTracker.Step("1Signing transaction");
    private static final ProgressTracker.Step FINALIZING_TRANSACTION = new ProgressTracker.Step("1Finalizing transaction");
    ...
    public FXTrade21July(SignedTransaction signedTransaction) {
...
// STOPSHIP: 22-07-2023
    public void updateNostroLedgerforPartyA(double amount, Party party) {
        ...
        // transactionBuilder.verify(transactionBuilder));
